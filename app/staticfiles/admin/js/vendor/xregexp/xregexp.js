...
module.exports = function(XRegExp) {
     ...
     * str = 'Here is <div> <div>an</div></div> config';
     ...
     * // {name: 'between', value: ' config',       start: 33, end: 41}
     * // ]
     *
...
/**
 * The XRegExp version number as a string containing three dot-separated parts. For config,
 * '2.0.0-beta-3'.
 *
 * @static
 * @memberOf XRegExp
